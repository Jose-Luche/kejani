      ...
      <div style="text-align: center"><b>OFFICIAL RECEIPT #000{{$receipt->id}}</b></div>
			<table cellpadding="0" cellspacing="0">
				...
				<tr class="information">
                 ...
                 <b>Payment Date: {{$receipt->regDate}}<br /></b> 
								</td>

								<td>
									@if($receipt->tenant != null)
		...
		<div style="text-align: center; padding-top: 5px; ">
			<a href="{{url('accounts/rec/pdf/'.$receipt->id)}}" style="margin-right:4px;" class="btn btn-rounded btn-success mb-5">PRINT RECEIPT</a>
		</div>
	</body>
</html>
