      ...
      <div style="text-align: center"><b>INVOICE #000{{$invoice->id}}</b></div>
			<table cellpadding="0" cellspacing="0">
				...
				<tr class="total" id="total">
					...
					<td> 
						<b>Balance:{{number_format($invoice->projectionBalance($invoice->id),2)}} </b> 
		...
		<div style="text-align: center; padding-top: 5px; ">
			<a href="{{url('accounts/inv/pdf/'.$invoice->id)}}" style="margin-right:4px;" class="btn btn-rounded btn-success mb-5">PRINT INVOICE</a>
		</div>
